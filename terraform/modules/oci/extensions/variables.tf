...
# -------------------------------------------------------------------------
# Variables injected by the OKE wrapper module (not used everywhere but
# declared here so Terraform does not complain about unknown arguments)
# -------------------------------------------------------------------------

variable "cluster_kubeconfig" {
  type        = string
  description = "Kubeconfig content or path provided by the parent module. Declared for compatibility."
  nullable    = true
  default     = null
}
...
variable "bastion_public_ip" {
  type        = string
  description = "Public IP of the bastion host (if any). Declared for compatibility."
  nullable    = true
  default     = null
}
...
variable "bastion_ssh_user" {
  type        = string
  description = "SSH user for the bastion host (if any). Declared for compatibility."
  nullable    = true
  default     = null
}
...
variable "bastion_ssh_private_key" {
  type        = string
  description = "Private key content for the bastion host (if any). Declared for compatibility."
  sensitive   = true
  nullable    = true
  default     = null
}
